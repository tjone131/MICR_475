...
```{r BadPlot, message=FALSE, warning=FALSE, eval=TRUE}
...
petals.n.sepals + 
 ...
 ![petals_n_sepals_bad](https://user-images.githubusercontent.com/89625876/145122815-6c3b30aa-4c5a-4fb5-84ed-6f0c5d259872.jpg)
...
```{r, GoodPlot, message=FALSE, warning=FALSE, eval=TRUE}
ggplot(data=iris, mapping=aes(x= Sepal.Length, y= Petal.Length, colour= Species))+
  ...
  ![petals_n_sepals_good](https://user-images.githubusercontent.com/89625876/145122856-cd719e44-9745-4271-868b-e34f467ed3df.jpg)
```
